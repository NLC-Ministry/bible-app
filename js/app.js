...
import './copy/zh-Hant.js?v=20260809_fix-admin-system-panel-grid-column-and-export-btn';
import './data/church_campaign.js?v=20260809_fix-admin-system-panel-grid-column-and-export-btn';
import './design/design-tokens.js';
import './design/design-system-helpers.js?v=20260809_fix-admin-system-panel-grid-column-and-export-btn';
import './design/icon-registry.js?v=20260809_fix-admin-system-panel-grid-column-and-export-btn';
import './design/icons.js';
import './state.js?v=20260809_fix-admin-system-panel-grid-column-and-export-btn';
import './auth.js?v=20260809_fix-admin-system-panel-grid-column-and-export-btn';
import './auth-launch.mjs';
import './db.js?v=20260809_fix-admin-system-panel-grid-column-and-export-btn';
import './utils.js?v=20260809_fix-admin-system-panel-grid-column-and-export-btn';
import './gamification.js?v=20260809_fix-admin-system-panel-grid-column-and-export-btn';
import { initModalManager } from './modules/modal-manager.mjs';

import { cleanupProductionStorage } from './production-cleanup.mjs';
import { initializePwa } from './pwa/PwaCoordinator.js?v=20260809_fix-admin-system-panel-grid-column-and-export-btn';
...
const moduleCache = {};
const RELEASE_ONBOARDING_MODULE_PATH = './modules/onboarding-helper.js?v=20260809_fix-admin-system-panel-grid-column-and-export-btn';
