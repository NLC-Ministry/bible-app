...
import './copy/zh-Hant.js?v=20260807_fix_managed_scope_null_write';
import './data/church_campaign.js?v=20260807_fix_managed_scope_null_write';
import './design/design-tokens.js';
import './design/design-system-helpers.js?v=20260807_fix_managed_scope_null_write';
import './design/icon-registry.js?v=20260807_fix_managed_scope_null_write';
import './design/icons.js';
import './state.js?v=20260807_fix_managed_scope_null_write';
import './auth.js?v=20260807_fix_managed_scope_null_write';
import './auth-launch.mjs';
import './db.js?v=20260807_fix_managed_scope_null_write';
import './utils.js?v=20260807_fix_managed_scope_null_write';
import './gamification.js?v=20260807_fix_managed_scope_null_write';
import { initModalManager } from './modules/modal-manager.mjs';

import { cleanupProductionStorage } from './production-cleanup.mjs';
import { initializePwa } from './pwa/PwaCoordinator.js?v=20260807_fix_managed_scope_null_write';
...
const moduleCache = {};
const RELEASE_ONBOARDING_MODULE_PATH = './modules/onboarding-helper.js?v=20260807_fix_managed_scope_null_write';
