...
import './copy/zh-Hant.js?v=20260808_fix_team_overview_missing_region_group_fields';
import './data/church_campaign.js?v=20260808_fix_team_overview_missing_region_group_fields';
import './design/design-tokens.js';
import './design/design-system-helpers.js?v=20260808_fix_team_overview_missing_region_group_fields';
import './design/icon-registry.js?v=20260808_fix_team_overview_missing_region_group_fields';
import './design/icons.js';
import './state.js?v=20260808_fix_team_overview_missing_region_group_fields';
import './auth.js?v=20260808_fix_team_overview_missing_region_group_fields';
import './auth-launch.mjs';
import './db.js?v=20260808_fix_team_overview_missing_region_group_fields';
import './utils.js?v=20260808_fix_team_overview_missing_region_group_fields';
import './gamification.js?v=20260808_fix_team_overview_missing_region_group_fields';
import { initModalManager } from './modules/modal-manager.mjs';

import { cleanupProductionStorage } from './production-cleanup.mjs';
import { initializePwa } from './pwa/PwaCoordinator.js?v=20260808_fix_team_overview_missing_region_group_fields';
...
const moduleCache = {};
const RELEASE_ONBOARDING_MODULE_PATH = './modules/onboarding-helper.js?v=20260808_fix_team_overview_missing_region_group_fields';
