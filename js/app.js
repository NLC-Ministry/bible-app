...
import './copy/zh-Hant.js?v=20260805_direct_auto_redirect_no_modal';
import './data/church_campaign.js?v=20260805_direct_auto_redirect_no_modal';
import './design/design-tokens.js';
import './design/design-system-helpers.js?v=20260805_direct_auto_redirect_no_modal';
import './design/icon-registry.js?v=20260805_direct_auto_redirect_no_modal';
import './design/icons.js';
import './state.js?v=20260805_direct_auto_redirect_no_modal';
import './auth.js?v=20260805_direct_auto_redirect_no_modal';
import './auth-launch.mjs';
import './db.js?v=20260805_direct_auto_redirect_no_modal';
import './utils.js?v=20260805_direct_auto_redirect_no_modal';
import './gamification.js?v=20260805_direct_auto_redirect_no_modal';

import { cleanupProductionStorage } from './production-cleanup.mjs';
import { initializePwa } from './pwa/PwaCoordinator.js?v=20260805_direct_auto_redirect_no_modal';
...
const moduleCache = {};
const RELEASE_ONBOARDING_MODULE_PATH = './modules/onboarding-helper.js?v=20260805_direct_auto_redirect_no_modal';
