...
import './copy/zh-Hant.js?v=20260805_plan_reset_badge_recalibration';
import './data/church_campaign.js?v=20260805_plan_reset_badge_recalibration';
import './design/design-tokens.js';
import './design/design-system-helpers.js?v=20260805_plan_reset_badge_recalibration';
import './design/icon-registry.js?v=20260805_plan_reset_badge_recalibration';
import './design/icons.js';
import './state.js?v=20260805_plan_reset_badge_recalibration';
import './auth.js?v=20260805_plan_reset_badge_recalibration';
import './auth-launch.mjs';
import './db.js?v=20260805_plan_reset_badge_recalibration';
import './utils.js?v=20260805_plan_reset_badge_recalibration';
import './gamification.js?v=20260805_plan_reset_badge_recalibration';

import { cleanupProductionStorage } from './production-cleanup.mjs';
import { initializePwa } from './pwa/PwaCoordinator.js?v=20260805_plan_reset_badge_recalibration';
...
const moduleCache = {};
const RELEASE_ONBOARDING_MODULE_PATH = './modules/onboarding-helper.js?v=20260805_plan_reset_badge_recalibration';
