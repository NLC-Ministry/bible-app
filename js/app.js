...
import './copy/zh-Hant.js?v=20260805_fix_tab_navigation_lifecycle_test';
import './data/church_campaign.js?v=20260805_fix_tab_navigation_lifecycle_test';
import './design/design-tokens.js';
import './design/design-system-helpers.js?v=20260805_fix_tab_navigation_lifecycle_test';
import './design/icon-registry.js?v=20260805_fix_tab_navigation_lifecycle_test';
import './design/icons.js';
import './state.js?v=20260805_fix_tab_navigation_lifecycle_test';
import './auth.js?v=20260805_fix_tab_navigation_lifecycle_test';
import './auth-launch.mjs';
import './db.js?v=20260805_fix_tab_navigation_lifecycle_test';
import './utils.js?v=20260805_fix_tab_navigation_lifecycle_test';
import './gamification.js?v=20260805_fix_tab_navigation_lifecycle_test';

import { cleanupProductionStorage } from './production-cleanup.mjs';
import { initializePwa } from './pwa/PwaCoordinator.js?v=20260805_fix_tab_navigation_lifecycle_test';
...
const moduleCache = {};
const RELEASE_ONBOARDING_MODULE_PATH = './modules/onboarding-helper.js?v=20260805_fix_tab_navigation_lifecycle_test';
