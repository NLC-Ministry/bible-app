...
import './copy/zh-Hant.js?v=20260805_direct_clean_redirect_no_popup';
import './data/church_campaign.js?v=20260805_direct_clean_redirect_no_popup';
import './design/design-tokens.js';
import './design/design-system-helpers.js?v=20260805_direct_clean_redirect_no_popup';
import './design/icon-registry.js?v=20260805_direct_clean_redirect_no_popup';
import './design/icons.js';
import './state.js?v=20260805_direct_clean_redirect_no_popup';
import './auth.js?v=20260805_direct_clean_redirect_no_popup';
import './auth-launch.mjs';
import './db.js?v=20260805_direct_clean_redirect_no_popup';
import './utils.js?v=20260805_direct_clean_redirect_no_popup';
import './gamification.js?v=20260805_direct_clean_redirect_no_popup';

import { cleanupProductionStorage } from './production-cleanup.mjs';
import { initializePwa } from './pwa/PwaCoordinator.js?v=20260805_direct_clean_redirect_no_popup';
...
const moduleCache = {};
const RELEASE_ONBOARDING_MODULE_PATH = './modules/onboarding-helper.js?v=20260805_direct_clean_redirect_no_popup';
