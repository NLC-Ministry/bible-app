...
appRouter.switchTab = async function (tabId, options = {}) {
  ...
  try {
    ...
    if (tabId === "dashboard-view") {
      ...
      const mod = await loadModule('plan', './modules/plan.js?v=20260710_theme_toggle_complete');
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  loadModule('plan', './modules/plan.js?v=20260710_theme_toggle_complete').then(mod => {
    if (mod && typeof mod.renderPlanView === 'function') {
