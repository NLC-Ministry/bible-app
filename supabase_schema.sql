...
CREATE TABLE IF NOT EXISTS public.profiles (
  ...
  name TEXT NOT NULL,
  great_region TEXT NOT NULL, -- 新增：所屬大區 (例如：第一大區、南區)
  pastoral_zone TEXT NOT NULL,
  small_group TEXT NOT NULL,
  role TEXT NOT NULL DEFAULT 'member', -- 新增：權限角色 (member, group_leader, zone_leader, great_zone_leader, admin, senior_pastor)
