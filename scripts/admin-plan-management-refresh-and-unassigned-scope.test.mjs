...
describe("計劃管理: explicit refresh button", () => {
  it("adds a 更新 button next to the shared org filter, above the 4 subtabs", () => {
    const panelStart = html.indexOf('id="admin-plans-panel"');
    const filterCardEnd = html.indexOf('id="admin-plan-subtabs"', panelStart);
    const filterArea = html.slice(panelStart, filterCardEnd);
